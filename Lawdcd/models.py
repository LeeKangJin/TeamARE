...
class Lawdcd(models.Model):
    Local_code = models.TextField(db_column='Local_code')  # Field name made lowercase.
    Deal_ymd = models.TextField(db_column='Deal_ymd')  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'Lawdcd'
        unique_together = (('Local_code', 'Deal_ymd'),)
